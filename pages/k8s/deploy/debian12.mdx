...
```
修改集群默认配置
```yaml copy filename="kubeadm.yaml" showLineNumbers {20,34,41,92-94}
...
```yaml copy filename="values.yaml" showLineNumbers {11-15,18,20}
controller:
