...
```yaml copy filename="docker-compose.yml" showLineNumbers {88-92,102,103,112,114}
version: '3'
networks:
  pulsar:
    driver: bridge
...
```properties cpoy filename="application.properties" showLineNumbers {19,20,78,97,98}
#
